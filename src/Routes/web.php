...
Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'DarkMegas\LaravelInstaller\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'DarkMegas\LaravelInstaller\Controllers', 'middleware' => 'web'], function () {
